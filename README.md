...
Demo Link: [Try the App](https://appetize.io/app/b_vedhknrkqeksjc4kq2safvcppm?device=pixel8pro&osVersion=14.0&scale=auto&orientation=portrait&location=40.4777,-3.6883&autoplay=true) [For expensive billing purposes the search functionality API is disableled until Demo day] [But in /demo_video folder you can check it out]
