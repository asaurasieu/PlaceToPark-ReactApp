...
export default function SlotsScreen() {
    ...
    useEffect(() => {
        ...
        ws.onmessage = (event) => {
            ...
            if (data && typeof data === 'object' && data.hasOwnProperty('available') && data.hasOwnProperty('total') && data.hasOwnProperty('spots')) {
                setParkingData(({
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.spotInfo}>Available Spots: {parkingData.available}</Text>
            <ScrollView style={styles.spotsContainer} contentContainerStyle={styles.spotsContentContainer}>
                {parkingData.spots.map(spot => (
                    <View key={spot.id} style={[styles.spot, spot.isAvailable ? styles.available : styles.unavailable]}>
